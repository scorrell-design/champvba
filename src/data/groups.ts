...
export const GROUPS: Group[] = [
  {
    ...
    eligibilityContact: { name: 'Sandra Wells', email: 'sandra.wells@apexmfg.com', phone: '(313) 555-0145', title: 'Benefits Administrator' },
  ...
  },
  {
    ...
    eligibilityContact: { name: 'Priya Desai', email: 'priya.desai@redwoodfinancial.com', phone: '(415) 555-2810', title: 'HR Director' },
    agentName: 'Diana Cho',
    agentNumber: 'A-4456',
  ...
  },
  {
    ...
    eligibilityContact: { name: 'Martin Reeves', email: 'martin.reeves@coastallogistics.com', title: 'Payroll Manager' },
  ...
  },
  {
    ...
    eligibilityContact: { name: 'Karen Trujillo', email: 'karen.trujillo@summithcp.com', phone: '(720) 555-3105', title: 'Benefits Coordinator' },
  ...
  },
  {
    ...
    eligibilityContact: { name: 'Cody Hartmann', email: 'cody.hartmann@prairiewind.energy', title: 'HR Manager' },
  ...
  },
  {
    ...
    eligibilityContact: { name: 'Alice Donovan', email: 'alice.donovan@ironbridgeinc.com', phone: '(412) 555-0895', title: 'Office Manager' },
